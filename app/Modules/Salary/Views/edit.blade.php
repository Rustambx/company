                                    ...
                                    <form action="{{ route('salary.update', $salary->id) }}" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="price" id="price" value="{{ $salary->price }}" placeholder="Оплата">
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="type" id="type" class="form-control">
                                                    ...
                                                    @if($salary->type == 'salary')
                                                        <option value="salary" selected>Зарплата</option>
                                                    @else
                                                        <option value="salary">Зарплата</option>
                                                    @endif
                                                    @if($salary->type == 'prepayment')
                                                        <option value="prepayment" selected>Предоплата</option>
                                                    @else
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" name="payroll_date" id="payroll_date" value="{{ $salary->payroll_date }}" class="form-control">
                                            </div>
                                        </div>
